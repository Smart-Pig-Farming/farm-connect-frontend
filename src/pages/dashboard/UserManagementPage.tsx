        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 mb-6">
          <div className="border-b border-gray-200">
            ...
            <div className="sm:hidden p-3">
              <select
                value={activeTab}
                onChange={(e) => setActiveTab(e.target.value as "users" | "roles" | "permissions")}
              ...
              >
                ...
                <option value="permissions">⚙️ Permissions ({mockPermissions.length})</option>
              </select>
            </div>
          </div>
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
                    ...
                    <div className="relative w-full sm:w-64">
                      ...
                      <input
                        ...
                        className="pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 w-full text-sm"
                      />
                    </div>
                        ...
                        <tr key={user.id} className="hover:bg-gray-50">
                          ...
                          <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <div className="flex items-center justify-end gap-2">
                              ...
                              <button
                                className="text-gray-600 hover:text-gray-900 hover:cursor-pointer p-1"
                                title="Edit User"
                              ...
                              <button
                                className="text-red-600 hover:text-red-900 hover:cursor-pointer p-1"
                                title="Delete User"
                  ...
                  paginatedUsers.map((user) => (
                    ...
                    >
                      <div className="flex justify-between items-start mb-3">
                        ...
                        <div className="ml-3 flex-shrink-0">{getStatusBadge(user)}</div>
                      </div>
                      ...
                      <div className="grid grid-cols-2 gap-3 text-sm mb-4">
                        ...
                        <div className="min-w-0">
                          ...
                          <p className="text-gray-900 truncate">{user.createdAt}</p>
                        </div>
                      </div>
              ...
              {filteredUsers.length > 0 && (
                <div className="flex flex-col gap-4 mt-6">
                  ...
                  <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                    <span className="text-sm text-gray-700 text-center sm:text-left order-2 sm:order-1">
                  ...
                  >
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        className="flex-1 text-sm text-orange-600 border border-orange-600 px-3 py-2 rounded hover:bg-orange-50 hover:cursor-pointer transition-colors"
                      >
                        Edit Role
                      </button>
                    </div>
                ...
                {mockRoles.map((role) => (
                  ...
                  >
                    ...
                    <div className="flex items-start justify-between mb-3">
                      ...
                      <span className="ml-3 px-2 py-1 text-xs font-medium bg-blue-100 text-blue-800 rounded-full whitespace-nowrap">
                        {role.userCount} users
                      </span>
                    </div>
                    ...
                    <div className="pt-3 border-t border-gray-100">
                      <button
                        onClick={() => handleEditRole(role)}
                        className="w-full text-sm text-orange-600 border border-orange-600 px-4 py-2 rounded-lg hover:bg-orange-50 hover:cursor-pointer transition-colors flex items-center justify-center gap-2"
                      >
                        <Edit className="w-4 h-4" />
                        Edit Role
                      </button>
                  ...
                  <div className="md:hidden space-y-4">
                    {mockPermissions.map((permission) => (
                      ...
                      >
                        <div className="flex items-start justify-between mb-3">
                          <div className="flex-1">
                            <div className="font-mono text-sm bg-blue-100 text-blue-800 px-2 py-1 rounded inline-block mb-2">
                              {permission.name}
                            </div>
                        ...
                        <div className="flex justify-between items-start mb-3">
                          ...
                          <div className="flex gap-1">
                            <button
                              ...
                              className="text-orange-600 hover:text-orange-700 hover:cursor-pointer p-1 rounded hover:bg-orange-50 transition-colors"
                              title="Edit Action"
                            >
                              <Edit className="w-4 h-4" />
                            </button>
                            <button className="text-red-600 hover:text-red-700 hover:cursor-pointer p-1 rounded hover:bg-red-50 transition-colors">
                              <Trash2 className="w-4 h-4" />
                            </button>
                          </div>
                        </div>
